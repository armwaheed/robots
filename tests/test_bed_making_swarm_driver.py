...
def test_offer_help_defaults_to_last_requester():
    ...
    _run(
        driver.onPeerHelpRequested(
            "g1-1", "helpRequested", {"corner": "B", "reason": "stuck", "target": ""}
        )
    )
...
def test_peer_sees_help_request_in_its_own_history():
    ...
    _run(
        peer.onPeerHelpRequested(
            "g1-0", "helpRequested", {"corner": "A", "reason": "drifting", "target": ""}
        )
    )
...
def test_help_request_for_self_is_ignored():
    ...
    _run(
        driver.onPeerHelpRequested(
            "g1-0", "helpRequested", {"corner": "A", "reason": "x", "target": ""}
        )
    )
...
def test_auto_offer_triggers_when_free_peer_sees_a_request():
    ...
    _run(
        helper.onPeerHelpRequested(
            "g1-0", "helpRequested", {"corner": "A", "reason": "stuck", "target": ""}
        )
    )
