...
![Newton grippable fabric — sensor-gated grip and headward drag](media/newton_grippable_fabric_held_drag.gif)
...
| --- | --- |
| ![grip](media/still_lift.png) | ![drag](media/still_drag.png) |

The same run, as captured during review: [`media/screenshot_lift.png`](media/screenshot_lift.png),
[`media/screenshot_drag_b.png`](media/screenshot_drag_b.png). Animated:
[`media/newton_grippable_fabric_held_drag.gif`](media/newton_grippable_fabric_held_drag.gif).
