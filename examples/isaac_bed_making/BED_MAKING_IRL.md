...
`"voice"` service — built as [`robotics-connect/unitree/g1/voice`](https://github.com/arm/robotics-connect/tree/main/unitree/g1/voice)
...
module's [`README.md`](https://github.com/arm/robotics-connect/tree/main/unitree/g1/voice).
...
[robotics-connect locomotion binding](https://github.com/arm/robotics-connect): `LocoClient.BalanceStand`
...
[`SAFETY.md`](https://github.com/arm/robotics-connect/blob/main/SAFETY.md)):
...
[`lib/safe_stop.py`](https://github.com/arm/robotics-connect/blob/main/lib/safe_stop.py) (damps on
return/exception/SIGINT/SIGTERM). See [`SAFETY.md` §0](https://github.com/arm/robotics-connect/blob/main/SAFETY.md).
...
robotics-connect ([`lib/policy_deploy.py`](https://github.com/arm/robotics-connect/blob/main/lib/policy_deploy.py)
+ the [G1 `RobotIO` binding](https://github.com/arm/robotics-connect/blob/main/unitree/g1/deploy/g1_robot_io.py)).
...
- **Aborting a run = press ANY button.** In Develop mode the in-loop any-button latch catches it within one
  ...
  high-gain command (this broke a window once). See robotics-connect [`SAFETY.md`](https://github.com/arm/robotics-connect/blob/main/SAFETY.md).
...
[robotics-connect locomotion layer](https://github.com/arm/robotics-connect)), and **reach with the arm
...
[`lib/task_gate.py`](https://github.com/arm/robotics-connect/blob/main/lib/task_gate.py)):
