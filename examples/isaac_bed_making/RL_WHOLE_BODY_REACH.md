...
![The spring peel-off grip engaged — both free-base G1s hold the cover (one leaning in over the bed, one in the deep balance-squat), the cover following their hands. The grasp fires on a short-range hand sensor and a compliant D6 spring joint transmits the load, so each robot feels the cover and balances against it.](media/rl/spring_grip_engaged.png)
